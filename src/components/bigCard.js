...
const BigCard = (props) => {
    ...
    console.log(data);
    const { name, tag, url, featuredProducts, description, socialMedia } = data;
    ...
    <div className="big-card">
        <div className="firstSection">
            ...
            <div className="big-card-content">
                <Flippy onClick={() => {setLink(featuredProducts[0].url);}} flipOnHover={true} flipDirection="horizontal" style={{ height: '300px', margin: '20px' }}>
                    <FrontSide style={{ backgroundColor: '#41669d', padding: '0px'}} >
                        <img src={featuredProducts[0].img}/>
                    </FrontSide>
                    <BackSide style={{ backgroundColor: '#c9deeb', padding: '0px'}}>
                        <div style={{
                            ...
                            <p style={{color: '#2d3b6b'}}>{featuredProducts[0].description}</p>
                        </div>
                    </BackSide>
                </Flippy>
                <Flippy onClick={() => {setLink(featuredProducts[1].url);}} flipOnHover={true} flipDirection="horizontal" style={{ height: '350px', margin: '20px'  }}>
                    <FrontSide style={{ backgroundColor: '#41669d', padding: '0px'}} >
                        <img src={featuredProducts[1].img}/>
                    </FrontSide>
                    <BackSide style={{ backgroundColor: '#c9deeb', padding: '0px'}}>
                        <div style={{
                                // backgroundImage: `url(${featuredProducts[0].img})`,
                            ...
                            <h3
                                style={{color: '#2d3b6b'}}
                            >{featuredProducts[1].name}</h3>
                            <p style={{color: '#2d3b6b'}}>{featuredProducts[1].description}</p>
                        </div>
                    </BackSide>
                </Flippy>
                <Flippy onClick={() => {setLink(featuredProducts[2].url);}} flipOnHover={true} flipDirection="horizontal" style={{ height: '300px', margin: '20px'  }}>
                    <FrontSide style={{ backgroundColor: '#fff', padding: '0px'}} >
                        <img src={featuredProducts[2].img}/>
                    </FrontSide>
                    <BackSide style={{ backgroundColor: '#c9deeb', padding: '0px'}}>
                        <div style={{
                                // backgroundImage: `url(${featuredProducts[2].img})`,
                                // backgroundSize: 'cover',
                                marginLeft: '10px',
                                marginRight: '10px'
                            }} className='grayout'>
                            <h3
                                style={{color: '#2d3b6b'}}
                            >{featuredProducts[2].name}</h3>
                            <p style={{color: '#2d3b6b'}}>{featuredProducts[2].description}</p>
                        </div>
                    </BackSide>
                </Flippy>
            </div>
        ...
        <div className='bigBottom'>
            <div className='bigBtmText'>
                <h3 onClick={() => {setLink(url);}}>{name}</h3>
                <p>{description}</p>
            </div>
            <div className='socialsBig'>
                <div>
                    <svg onClick={() => {setLink(socialMedia[0].url);}} xmlns="http://www.w3.org/2000/svg" width="36" height="36" viewBox="0 0 36 36" fill="none">
                    ...
                    <svg onClick={() => {setLink(socialMedia[1].url);}} xmlns="http://www.w3.org/2000/svg" width="36" height="36" viewBox="0 0 36 36" fill="none">
